      ...
      <div className="glass animate-fade-in login-box" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem', position: 'relative' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem', transition: 'all 0.3s ease' }}>
            <img src="/logo.png" alt="Ephrad POS Logo" style={{ height: '72px', borderRadius: '12px', objectFit: 'contain', filter: 'drop-shadow(0 4px 12px rgba(16, 185, 129, 0.15))', opacity: 0.95, transition: 'all 0.3s ease' }} />
          </div>
