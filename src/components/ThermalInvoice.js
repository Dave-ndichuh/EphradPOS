...
const ThermalInvoice = React.forwardRef(({ invoice, items, isQuote = false }, ref) => {
  ...
  return (
    <div className="receipt-print-area" ref={ref}>
      ...
      <div className="receipt-footer">
        ...
        <p>This is a standalone {isQuote ? 'quotation' : 'invoice'}. {isQuote ? 'Prices are subject to regular review.' : 'Goods remain property of Ephrad Technology until settled.'}</p>
        {!isQuote && (
          <>
