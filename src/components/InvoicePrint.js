    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '10px' }}>
          <img src="/logo.png" alt="Ephrad Technology" style={{ height: '40px', borderRadius: '8px', objectFit: 'contain' }} />
          <h2 style={{ 
            fontSize: '24px', 
            fontWeight: 600, 
            color: '#4a5568', 
        ...
        <div style={{ width: '50%' }}>
          <div style={{ marginBottom: '30px' }}>
            ...
            <p style={{ margin: 0, fontSize: '13px', color: '#4a5568', lineHeight: '1.5' }}>
              This is a standalone {isQuote ? 'quotation' : 'invoice'}. {isQuote ? 'Prices are subject to regular review.' : 'Stock is not deducted or reserved until full payment is received. Goods remain the property of Ephrad Technology until the invoice is settled in full.'}
            </p>
            {!isQuote && (
